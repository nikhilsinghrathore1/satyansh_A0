...
export const perks = [
    {
        icon: Icons.auth,
        title: "Learn",
        info: "Create your free account to get started with Learning.",
    },
    {
        icon: Icons.customize,
        title: "Ask doubt",
        info: "all your doubt will be handled by our AI Tutor",
    },
    {
        icon: Icons.launch,
        title: "Test Yourself",
        info: "Give a personalise test created just for you by Ai",
    },
];
...
export const pricingCards = [
    {
        title: "Basic Maths",
        description: "learn the fundaments of maths ",
        price: "Free",
        duration: "",
        highlight: "Key features",
        buttonText: "Start for free",
        features: ["Limited Batch", "1 Teacher/member", "Basic features"],
        priceId: "",
    },
    {
        title: "basic coding",
        description: "dive into the world of coding",
        price: "$199",
        duration: "6 months",
        highlight: "Associated Dsa learning software",
        buttonText: "buy now / Free Trial",
        features: ["Unlimited projects", "group learning", "Advanced design tools", "Customizable domain"],
        priceId: "price_1OYxkqFj9oKEERu1KfJGWxgN",
    },
    {
        title: "Graphic Designing",
        description: "for those who targets design agency",
        price: "$399",
        duration: "6month",
        highlight: "Everything in Starter, plus",
        buttonText: "buy now / free trial",
        features: ["Unlimited projects", "Unlimited Team members", "access to our uni4.o", "Priority support (24/7)"],
