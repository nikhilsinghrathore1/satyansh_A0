                    ...
                    <div className="flex flex-col items-center justify-center py-20 h-full">
                        <button className="group relative grid overflow-hidden rounded-full px-4 py-1 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200">
                            ...
                            <span className="z-10 py-0.5 text-sm text-neutral-100 flex items-center justify-center gap-1.5">
                                ...
                                Experience Joy of learning
                                <ChevronRight className="w-4 h-4" />
                            </span>
                        </button>

                        <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
                            <h1 className="text-4xl md:text-[3rem]  lg:textxl md:!leading-snug font-semibold text-center bg-clip-text bg-gradient-to-b from-gray-50 to-gray-50 text-transparent">
                                leave your disablities behind and Start learning with us
                            </h1>
                            <p className="text-base md:text-lg text-foreground/80 mt-6 text-center">
                                Zero stree, maximum fun. Make professional skill easy understandable,while delivering best-in-class Education, experience.
                            </p>
                ...
                <Container>
                    <div className="max-w-xl mx-auto text-start md:text-center">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-semibold mt-6">
                            Three steps to get the whole education Experience
                        </h2>
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <Container>
                    <div className="max-w-xl mx-auto text-start md:text-center">
                        ...
                        <h2 className="text-3xl lg:text-4xl font-semibold mt-6">
                            Unlock the endless potential in you with our AI
                        </h2>
                        <p className="text-muted-foreground mt-6 ">
                            Choose the best course for you and take your carer to the next level 
                        </p>
                    </div>
                </Container>
            ...
            <Wrapper className="flex flex-col items-center justify-center py-12 relative">
                ...
                <Container>
                    <div className="max-w-md mx-auto text-start md:text-center">
                        ...
                        <p className="text-muted-foreground mt-6">
                            See how we empowers differntly abled kids of all sizes. Here&apos;s what real people are saying on Twitter
                        </p>
                    </div>
                </Container>
                <Container>
                    ...
                    <LampContainer>
                        <div className="flex flex-col items-center justify-center relative w-full text-center">
                            <h2 className="text-4xl lg:text-5xl xl:text-6xl lg:!leading-snug font-semibold mt-8">
                                From Home to industry <br /> Faster Than Ever
                            </h2>
                            <p className="text-muted-foreground mt-6 max-w-md mx-auto">
                                Build stunning career with ours&apos;s intuitive teaching approach and powerful AI assistant
                            </p>
